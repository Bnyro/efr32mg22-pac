...
impl R {
    ...
    pub fn usart0(&self) -> Usart0R {
        Usart0R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Enable Bus Clock"]
    #[inline(always)]
    pub fn usart1(&self) -> Usart1R {
        Usart1R::new(((self.bits >> 9) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 9 - Enable Bus Clock"]
    #[inline(always)]
    pub fn usart1(&mut self) -> Usart1W<'_, Clken0Spec> {
        Usart1W::new(self, 9)
    }
    #[doc = "Bit 10 - Enable Bus Clock"]
    #[inline(always)]
    ...
    #[doc = "Bit 24 - Enable Bus Clock"]
    #[inline(always)]
    pub fn euart0(&mut self) -> Euart0W<'_, Clken0Spec> {
        Euart0W::new(self, 24)
    }
    #[doc = "Bit 25 - Enable Bus Clock"]
    #[inline(always)]
    pub fn pdm(&mut self) -> PdmW<'_, Clken0Spec> {
        PdmW::new(self, 25)
    }
    #[doc = "Bit 26 - Enable Bus Clock"]
    #[inline(always)]
    ...
    #[doc = "Bit 30 - Enable Bus Clock"]
    #[inline(always)]
    pub fn rtcc(&mut self) -> RtccW<'_, Clken0Spec> {
        RtccW::new(self, 30)
    }
    #[doc = "Bit 31 - Enable Bus Clock"]
    #[inline(always)]
