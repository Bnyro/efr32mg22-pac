...
pub type OnlinerepthreshR = crate::FieldReader<u16>;
#[doc = "Field `ONLINEREPTHRESH` writer - Online Repeat Threshold"]
pub type OnlinerepthreshW<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
impl R {
    #[doc = "Bits 0:14 - Expected History Value"]
    #[inline(always)]
    pub fn hexpectedvalue(&self) -> HexpectedvalueR {
        HexpectedvalueR::new((self.bits & 0x7fff) as u16)
    }
    #[doc = "Bits 16:30 - Online Repeat Threshold"]
    #[inline(always)]
    pub fn onlinerepthresh(&self) -> OnlinerepthreshR {
        OnlinerepthreshR::new(((self.bits >> 16) & 0x7fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:14 - Expected History Value"]
    ...
    pub fn hexpectedvalue(&mut self) -> HexpectedvalueW<'_, Ais31conf1Spec> {
        HexpectedvalueW::new(self, 0)
    }
    #[doc = "Bits 16:30 - Online Repeat Threshold"]
    #[inline(always)]
    pub fn onlinerepthresh(&mut self) -> OnlinerepthreshW<'_, Ais31conf1Spec> {
        OnlinerepthreshW::new(self, 16)
    }
}
