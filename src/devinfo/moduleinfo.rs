...
impl LfxoR {
    ...
    #[doc = "LFXO is not installed"]
    #[inline(always)]
    pub fn is_none(&self) -> bool {
        *self == Lfxo::None
    }
    #[doc = "LFXO is installed"]
    #[inline(always)]
...
pub enum Express {
    ...
    Supported = 0,
    #[doc = "1: Blue Gecko Express is not supported"]
    None = 1,
}
...
impl ExpressR {
    ...
    #[doc = "Blue Gecko Express is supported"]
    #[inline(always)]
    pub fn is_supported(&self) -> bool {
        *self == Express::Supported
    }
    #[doc = "Blue Gecko Express is not supported"]
    #[inline(always)]
    pub fn is_none(&self) -> bool {
        *self == Express::None
    }
...
pub enum Lfxocalval {
    ...
    Valid = 0,
    #[doc = "1: LFXO Tuning value in MODXOCAL is not valid"]
    Notvalid = 1,
}
...
impl LfxocalvalR {
    ...
    #[doc = "LFXO Tuning in MODXOCAL is valid"]
    #[inline(always)]
    pub fn is_valid(&self) -> bool {
        *self == Lfxocalval::Valid
    }
    #[doc = "LFXO Tuning value in MODXOCAL is not valid"]
    #[inline(always)]
...
pub enum Hfxocalval {
    ...
    Valid = 0,
    #[doc = "1: HFXO calibration in MODXOCAL is not valid"]
    Notvalid = 1,
}
...
impl HfxocalvalR {
    ...
    #[doc = "HFXO calibration in MODXOCAL is valid"]
    #[inline(always)]
    pub fn is_valid(&self) -> bool {
        *self == Hfxocalval::Valid
    }
    #[doc = "HFXO calibration in MODXOCAL is not valid"]
    #[inline(always)]
    pub fn is_notvalid(&self) -> bool {
...
pub enum Padcdc {
    ...
    Vdcdc = 0,
    #[doc = "1: PAVDD connected to Vdd or other"]
    Other = 1,
}
...
impl PadcdcR {
    ...
    #[doc = "PAVDD connected to Vdcdc"]
    #[inline(always)]
    pub fn is_vdcdc(&self) -> bool {
        *self == Padcdc::Vdcdc
    }
    #[doc = "PAVDD connected to Vdd or other"]
    #[inline(always)]
