...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Dcirmode {
    #[doc = "0: Reset request blocked"]
    Disabled = 0,
    #[doc = "1: The entire device is reset except some EMU registers"]
    Enabled = 1,
}
impl From<Dcirmode> for bool {
    #[inline(always)]
    fn from(variant: Dcirmode) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `DCIRMODE` reader - DCI System reset"]
pub type DcirmodeR = crate::BitReader<Dcirmode>;
impl DcirmodeR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Dcirmode {
        match self.bits {
            false => Dcirmode::Disabled,
            true => Dcirmode::Enabled,
        }
    }
    #[doc = "Reset request blocked"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == Dcirmode::Disabled
    }
    #[doc = "The entire device is reset except some EMU registers"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == Dcirmode::Enabled
    }
}
#[doc = "Field `DCIRMODE` writer - DCI System reset"]
pub type DcirmodeW<'a, REG> = crate::BitWriter<'a, REG, Dcirmode>;
impl<'a, REG> DcirmodeW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Reset request blocked"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(Dcirmode::Disabled)
    }
    #[doc = "The entire device is reset except some EMU registers"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(Dcirmode::Enabled)
    }
}
impl R {
    ...
    #[doc = "Bit 16 - DCI System reset"]
    #[inline(always)]
    pub fn dcirmode(&self) -> DcirmodeR {
        DcirmodeR::new(((self.bits >> 16) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Enable WDOG0 reset"]
    ...
    #[doc = "Bit 16 - DCI System reset"]
    #[inline(always)]
    pub fn dcirmode(&mut self) -> DcirmodeW<'_, RstctrlSpec> {
        DcirmodeW::new(self, 16)
    }
}
...
#[doc = "`reset()` method sets RSTCTRL to value 0x4001_0407"]
impl crate::Resettable for RstctrlSpec {
    const RESET_VALUE: u32 = 0x4001_0407;
}
