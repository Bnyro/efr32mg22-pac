...
pub enum Pd1paretdis {
    #[doc = "0: Retain associated registers when in EM2/3"]
    Retain = 0,
    #[doc = "1: Do not retain associcated registers when in EM2/3"]
    Noretain = 1,
}
...
impl Pd1paretdisR {
    ...
    pub const fn variant(&self) -> Option<Pd1paretdis> {
        match self.bits {
            0 => Some(Pd1paretdis::Retain),
            1 => Some(Pd1paretdis::Noretain),
            _ => None,
        }
    }
    ...
    pub fn is_retain(&self) -> bool {
        *self == Pd1paretdis::Retain
    }
    #[doc = "Do not retain associcated registers when in EM2/3"]
    #[inline(always)]
    pub fn is_noretain(&self) -> bool {
        *self == Pd1paretdis::Noretain
    }
}
    ...
    REG::Ux: From<u16>,
{
    #[doc = "Retain associated registers when in EM2/3"]
    #[inline(always)]
    pub fn retain(self) -> &'a mut crate::W<REG> {
        self.variant(Pd1paretdis::Retain)
    }
    #[doc = "Do not retain associcated registers when in EM2/3"]
    #[inline(always)]
    pub fn noretain(self) -> &'a mut crate::W<REG> {
        self.variant(Pd1paretdis::Noretain)
    }
}
impl R {
