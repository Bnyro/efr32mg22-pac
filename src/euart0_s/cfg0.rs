...
pub enum Errsdma {
    ...
    Disable = 0,
    #[doc = "1: DMA requests from the UART are blocked while the PERR or FERR interrupt flags are set"]
    Enable = 1,
}
...
impl ErrsdmaR {
    ...
    #[doc = "DMA requests from the UART are blocked while the PERR or FERR interrupt flags are set"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == Errsdma::Enable
    }
