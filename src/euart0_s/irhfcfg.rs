...
pub enum Irhffilt {
    ...
    Disable = 0,
    #[doc = "1: Filter enabled. IrDA pulse must be high for at least 4 consecutive clock cycles to be detected"]
    Enable = 1,
}
...
impl IrhffiltR {
    ...
    #[doc = "Filter enabled. IrDA pulse must be high for at least 4 consecutive clock cycles to be detected"]
    #[inline(always)]
