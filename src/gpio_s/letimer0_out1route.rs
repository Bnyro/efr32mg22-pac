...
pub type R = crate::R<Letimer0Out1routeSpec>;
#[doc = "Register `LETIMER0_OUT1ROUTE` writer"]
pub type W = crate::W<Letimer0Out1routeSpec>;
...
impl W {
    #[doc = "Bits 0:1 - OUT1 port select register"]
    #[inline(always)]
    pub fn port(&mut self) -> PortW<'_, Letimer0Out1routeSpec> {
        PortW::new(self, 0)
    }
    #[doc = "Bits 16:19 - OUT1 pin select register"]
    #[inline(always)]
    pub fn pin(&mut self) -> PinW<'_, Letimer0Out1routeSpec> {
        PinW::new(self, 16)
    }
}
...
pub struct Letimer0Out1routeSpec;
impl crate::RegisterSpec for Letimer0Out1routeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`letimer0_out1route::R`](R) reader structure"]
impl crate::Readable for Letimer0Out1routeSpec {}
#[doc = "`write(|w| ..)` method takes [`letimer0_out1route::W`](W) writer structure"]
impl crate::Writable for Letimer0Out1routeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LETIMER0_OUT1ROUTE to value 0"]
impl crate::Resettable for Letimer0Out1routeSpec {}
