#[doc = "Register `PORTB_MODEL` reader"]
pub type R = crate::R<PortbModelSpec>;
#[doc = "Register `PORTB_MODEL` writer"]
pub type W = crate::W<PortbModelSpec>;
#[doc = "MODE n\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:3 - MODE n"]
    #[inline(always)]
    pub fn mode0(&mut self) -> Mode0W<'_, PortbModelSpec> {
        Mode0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - MODE n"]
    #[inline(always)]
    pub fn mode1(&mut self) -> Mode1W<'_, PortbModelSpec> {
        Mode1W::new(self, 4)
    }
    #[doc = "Bits 8:11 - MODE n"]
    #[inline(always)]
    pub fn mode2(&mut self) -> Mode2W<'_, PortbModelSpec> {
        Mode2W::new(self, 8)
    }
    #[doc = "Bits 12:15 - MODE n"]
    #[inline(always)]
    pub fn mode3(&mut self) -> Mode3W<'_, PortbModelSpec> {
        Mode3W::new(self, 12)
    }
    #[doc = "Bits 16:19 - MODE n"]
    #[inline(always)]
    pub fn mode4(&mut self) -> Mode4W<'_, PortbModelSpec> {
        Mode4W::new(self, 16)
    }
}
#[doc = "mode low\n\nYou can [`read`](crate::Reg::read) this register and get [`portb_model::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`portb_model::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PortbModelSpec;
impl crate::RegisterSpec for PortbModelSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`portb_model::R`](R) reader structure"]
impl crate::Readable for PortbModelSpec {}
#[doc = "`write(|w| ..)` method takes [`portb_model::W`](W) writer structure"]
impl crate::Writable for PortbModelSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PORTB_MODEL to value 0"]
impl crate::Resettable for PortbModelSpec {}
