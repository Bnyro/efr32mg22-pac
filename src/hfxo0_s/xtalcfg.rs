...
impl TimeoutsteadyR {
    ...
    pub const fn variant(&self) -> Timeoutsteady {
        match self.bits {
            0 => Timeoutsteady::T16us,
            1 => Timeoutsteady::T41us,
            2 => Timeoutsteady::T83us,
            3 => Timeoutsteady::T125us,
            4 => Timeoutsteady::T166us,
            5 => Timeoutsteady::T208us,
            6 => Timeoutsteady::T250us,
            7 => Timeoutsteady::T333us,
            8 => Timeoutsteady::T416us,
            9 => Timeoutsteady::T500us,
            10 => Timeoutsteady::T666us,
            11 => Timeoutsteady::T833us,
            12 => Timeoutsteady::T1666us,
            13 => Timeoutsteady::T2500us,
            14 => Timeoutsteady::T4166us,
            15 => Timeoutsteady::T7500us,
            _ => unreachable!(),
        }
    }
    ...
    #[inline(always)]
    pub fn is_t7500us(&self) -> bool {
        *self == Timeoutsteady::T7500us
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "The steady state timeout is set to 7500 us minimum. The maximum can be +40%."]
    #[inline(always)]
    pub fn t7500us(self) -> &'a mut crate::W<REG> {
        self.variant(Timeoutsteady::T7500us)
    }
}
...
impl crate::Resettable for XtalcfgSpec {
    const RESET_VALUE: u32 = 0x0443_34cb;
}
