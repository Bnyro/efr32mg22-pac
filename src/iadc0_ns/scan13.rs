#[doc = "Register `SCAN13` reader"]
pub type R = crate::R<Scan13Spec>;
#[doc = "Register `SCAN13` writer"]
pub type W = crate::W<Scan13Spec>;
...
impl W {
    #[doc = "Bits 0:3 - Negative Pin Select"]
    #[inline(always)]
    pub fn pinneg(&mut self) -> PinnegW<'_, Scan13Spec> {
        PinnegW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Negative Port Select"]
    #[inline(always)]
    pub fn portneg(&mut self) -> PortnegW<'_, Scan13Spec> {
        PortnegW::new(self, 4)
    }
    #[doc = "Bits 8:11 - Positive Pin Select"]
    #[inline(always)]
    pub fn pinpos(&mut self) -> PinposW<'_, Scan13Spec> {
        PinposW::new(self, 8)
    }
    #[doc = "Bits 12:15 - Positive Port Select"]
    #[inline(always)]
    pub fn portpos(&mut self) -> PortposW<'_, Scan13Spec> {
        PortposW::new(self, 12)
    }
    #[doc = "Bit 16 - Configuration Group Select"]
    #[inline(always)]
    pub fn cfg(&mut self) -> CfgW<'_, Scan13Spec> {
        CfgW::new(self, 16)
    }
    #[doc = "Bit 17 - Comparison Enable"]
    #[inline(always)]
    pub fn cmp(&mut self) -> CmpW<'_, Scan13Spec> {
        CmpW::new(self, 17)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`scan13::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`scan13::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Scan13Spec;
impl crate::RegisterSpec for Scan13Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scan13::R`](R) reader structure"]
impl crate::Readable for Scan13Spec {}
#[doc = "`write(|w| ..)` method takes [`scan13::W`](W) writer structure"]
impl crate::Writable for Scan13Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SCAN13 to value 0"]
impl crate::Resettable for Scan13Spec {}
