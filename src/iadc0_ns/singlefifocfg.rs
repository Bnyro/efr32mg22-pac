...
pub type DvlW<'a, REG> = crate::FieldWriter<'a, REG, 2, Dvl, crate::Safe>;
...
impl W {
    #[doc = "Bits 0:2 - Alignment"]
    #[inline(always)]
    pub fn alignment(&mut self) -> AlignmentW<'_, SinglefifocfgSpec> {
        AlignmentW::new(self, 0)
    }
    #[doc = "Bit 3 - Show ID"]
    #[inline(always)]
    pub fn showid(&mut self) -> ShowidW<'_, SinglefifocfgSpec> {
        ShowidW::new(self, 3)
    }
    #[doc = "Bits 4:5 - Data Valid Level"]
    #[inline(always)]
    pub fn dvl(&mut self) -> DvlW<'_, SinglefifocfgSpec> {
        DvlW::new(self, 4)
    }
    #[doc = "Bit 8 - Single FIFO DMA wakeup."]
    #[inline(always)]
    pub fn dmawufifosingle(&mut self) -> DmawufifosingleW<'_, SinglefifocfgSpec> {
