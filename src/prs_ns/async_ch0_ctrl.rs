#[doc = "Register `ASYNC_CH0_CTRL` reader"]
pub type R = crate::R<AsyncCh0CtrlSpec>;
#[doc = "Register `ASYNC_CH0_CTRL` writer"]
pub type W = crate::W<AsyncCh0CtrlSpec>;
#[doc = "Signal Select\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:2 - Signal Select"]
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, AsyncCh0CtrlSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Source Select"]
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, AsyncCh0CtrlSpec> {
        SourceselW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Function Select"]
    #[inline(always)]
    pub fn fnsel(&mut self) -> FnselW<'_, AsyncCh0CtrlSpec> {
        FnselW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Auxiliary LUT Input Select"]
    #[inline(always)]
    pub fn auxsel(&mut self) -> AuxselW<'_, AsyncCh0CtrlSpec> {
        AuxselW::new(self, 24)
    }
}
...
pub struct AsyncCh0CtrlSpec;
impl crate::RegisterSpec for AsyncCh0CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`async_ch0_ctrl::R`](R) reader structure"]
impl crate::Readable for AsyncCh0CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`async_ch0_ctrl::W`](W) writer structure"]
impl crate::Writable for AsyncCh0CtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ASYNC_CH0_CTRL to value 0x000c_0000"]
impl crate::Resettable for AsyncCh0CtrlSpec {
