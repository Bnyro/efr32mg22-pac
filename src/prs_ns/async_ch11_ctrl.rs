...
pub type R = crate::R<AsyncCh11CtrlSpec>;
#[doc = "Register `ASYNC_CH11_CTRL` writer"]
pub type W = crate::W<AsyncCh11CtrlSpec>;
#[doc = "Signal Select\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:2 - Signal Select"]
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, AsyncCh11CtrlSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Source Select"]
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, AsyncCh11CtrlSpec> {
        SourceselW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Function Select"]
    #[inline(always)]
    pub fn fnsel(&mut self) -> FnselW<'_, AsyncCh11CtrlSpec> {
        FnselW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Auxiliary LUT Input Select"]
    #[inline(always)]
    pub fn auxsel(&mut self) -> AuxselW<'_, AsyncCh11CtrlSpec> {
        AuxselW::new(self, 24)
    }
}
...
pub struct AsyncCh11CtrlSpec;
impl crate::RegisterSpec for AsyncCh11CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`async_ch11_ctrl::R`](R) reader structure"]
impl crate::Readable for AsyncCh11CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`async_ch11_ctrl::W`](W) writer structure"]
impl crate::Writable for AsyncCh11CtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ASYNC_CH11_CTRL to value 0x000c_0000"]
impl crate::Resettable for AsyncCh11CtrlSpec {
