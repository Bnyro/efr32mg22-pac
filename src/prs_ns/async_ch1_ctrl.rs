#[doc = "Register `ASYNC_CH1_CTRL` reader"]
pub type R = crate::R<AsyncCh1CtrlSpec>;
#[doc = "Register `ASYNC_CH1_CTRL` writer"]
pub type W = crate::W<AsyncCh1CtrlSpec>;
#[doc = "Signal Select\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:2 - Signal Select"]
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, AsyncCh1CtrlSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Source Select"]
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, AsyncCh1CtrlSpec> {
        SourceselW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Function Select"]
    #[inline(always)]
    pub fn fnsel(&mut self) -> FnselW<'_, AsyncCh1CtrlSpec> {
        FnselW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Auxiliary LUT Input Select"]
    #[inline(always)]
    pub fn auxsel(&mut self) -> AuxselW<'_, AsyncCh1CtrlSpec> {
        AuxselW::new(self, 24)
    }
}
...
pub struct AsyncCh1CtrlSpec;
impl crate::RegisterSpec for AsyncCh1CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`async_ch1_ctrl::R`](R) reader structure"]
impl crate::Readable for AsyncCh1CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`async_ch1_ctrl::W`](W) writer structure"]
impl crate::Writable for AsyncCh1CtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ASYNC_CH1_CTRL to value 0x000c_0000"]
impl crate::Resettable for AsyncCh1CtrlSpec {
