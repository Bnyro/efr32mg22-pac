...
pub type R = crate::R<ConsumerTimer1Dtifs2Spec>;
#[doc = "Register `CONSUMER_TIMER1_DTIFS2` writer"]
pub type W = crate::W<ConsumerTimer1Dtifs2Spec>;
...
impl W {
    #[doc = "Bits 0:3 - DTI async channel select"]
    #[inline(always)]
    pub fn prssel(&mut self) -> PrsselW<'_, ConsumerTimer1Dtifs2Spec> {
        PrsselW::new(self, 0)
    }
}
...
pub struct ConsumerTimer1Dtifs2Spec;
impl crate::RegisterSpec for ConsumerTimer1Dtifs2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`consumer_timer1_dtifs2::R`](R) reader structure"]
impl crate::Readable for ConsumerTimer1Dtifs2Spec {}
#[doc = "`write(|w| ..)` method takes [`consumer_timer1_dtifs2::W`](W) writer structure"]
impl crate::Writable for ConsumerTimer1Dtifs2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CONSUMER_TIMER1_DTIFS2 to value 0"]
impl crate::Resettable for ConsumerTimer1Dtifs2Spec {}
