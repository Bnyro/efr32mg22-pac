#[doc = "Register `CONSUMER_TIMER3_DTI` reader"]
pub type R = crate::R<ConsumerTimer3DtiSpec>;
#[doc = "Register `CONSUMER_TIMER3_DTI` writer"]
pub type W = crate::W<ConsumerTimer3DtiSpec>;
...
impl W {
    #[doc = "Bits 0:3 - DTI async channel select"]
    #[inline(always)]
    pub fn prssel(&mut self) -> PrsselW<'_, ConsumerTimer3DtiSpec> {
        PrsselW::new(self, 0)
    }
}
...
pub struct ConsumerTimer3DtiSpec;
impl crate::RegisterSpec for ConsumerTimer3DtiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`consumer_timer3_dti::R`](R) reader structure"]
impl crate::Readable for ConsumerTimer3DtiSpec {}
