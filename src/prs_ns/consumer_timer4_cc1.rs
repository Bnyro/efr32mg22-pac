#[doc = "Register `CONSUMER_TIMER4_CC1` reader"]
pub type R = crate::R<ConsumerTimer4Cc1Spec>;
#[doc = "Register `CONSUMER_TIMER4_CC1` writer"]
pub type W = crate::W<ConsumerTimer4Cc1Spec>;
...
impl W {
    #[doc = "Bits 0:3 - CC1 async channel select"]
    #[inline(always)]
    pub fn prssel(&mut self) -> PrsselW<'_, ConsumerTimer4Cc1Spec> {
        PrsselW::new(self, 0)
    }
    #[doc = "Bits 8:9 - CC1 sync channel select"]
    #[inline(always)]
    pub fn sprssel(&mut self) -> SprsselW<'_, ConsumerTimer4Cc1Spec> {
        SprsselW::new(self, 8)
    }
}
...
pub struct ConsumerTimer4Cc1Spec;
impl crate::RegisterSpec for ConsumerTimer4Cc1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`consumer_timer4_cc1::R`](R) reader structure"]
impl crate::Readable for ConsumerTimer4Cc1Spec {}
#[doc = "`write(|w| ..)` method takes [`consumer_timer4_cc1::W`](W) writer structure"]
impl crate::Writable for ConsumerTimer4Cc1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CONSUMER_TIMER4_CC1 to value 0"]
impl crate::Resettable for ConsumerTimer4Cc1Spec {}
