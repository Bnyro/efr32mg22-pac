#[doc = "Register `ASYNC_CH10_CTRL` reader"]
pub type R = crate::R<AsyncCh10CtrlSpec>;
#[doc = "Register `ASYNC_CH10_CTRL` writer"]
pub type W = crate::W<AsyncCh10CtrlSpec>;
#[doc = "Signal Select\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:2 - Signal Select"]
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, AsyncCh10CtrlSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Source Select"]
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, AsyncCh10CtrlSpec> {
        SourceselW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Function Select"]
    #[inline(always)]
    pub fn fnsel(&mut self) -> FnselW<'_, AsyncCh10CtrlSpec> {
        FnselW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Auxiliary LUT Input Select"]
    #[inline(always)]
    pub fn auxsel(&mut self) -> AuxselW<'_, AsyncCh10CtrlSpec> {
        AuxselW::new(self, 24)
    }
}
...
pub struct AsyncCh10CtrlSpec;
impl crate::RegisterSpec for AsyncCh10CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`async_ch10_ctrl::R`](R) reader structure"]
impl crate::Readable for AsyncCh10CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`async_ch10_ctrl::W`](W) writer structure"]
impl crate::Writable for AsyncCh10CtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ASYNC_CH10_CTRL to value 0x000c_0000"]
impl crate::Resettable for AsyncCh10CtrlSpec {
