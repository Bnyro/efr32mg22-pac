#[doc = "Register `ASYNC_CH2_CTRL` reader"]
pub type R = crate::R<AsyncCh2CtrlSpec>;
#[doc = "Register `ASYNC_CH2_CTRL` writer"]
pub type W = crate::W<AsyncCh2CtrlSpec>;
#[doc = "Signal Select\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:2 - Signal Select"]
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, AsyncCh2CtrlSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Source Select"]
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, AsyncCh2CtrlSpec> {
        SourceselW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Function Select"]
    #[inline(always)]
    pub fn fnsel(&mut self) -> FnselW<'_, AsyncCh2CtrlSpec> {
        FnselW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Auxiliary LUT Input Select"]
    #[inline(always)]
    pub fn auxsel(&mut self) -> AuxselW<'_, AsyncCh2CtrlSpec> {
        AuxselW::new(self, 24)
    }
}
...
pub struct AsyncCh2CtrlSpec;
impl crate::RegisterSpec for AsyncCh2CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`async_ch2_ctrl::R`](R) reader structure"]
impl crate::Readable for AsyncCh2CtrlSpec {}
