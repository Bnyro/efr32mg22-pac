...
pub type R = crate::R<AsyncCh6CtrlSpec>;
#[doc = "Register `ASYNC_CH6_CTRL` writer"]
pub type W = crate::W<AsyncCh6CtrlSpec>;
#[doc = "Signal Select\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:2 - Signal Select"]
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, AsyncCh6CtrlSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Source Select"]
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, AsyncCh6CtrlSpec> {
        SourceselW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Function Select"]
    #[inline(always)]
    pub fn fnsel(&mut self) -> FnselW<'_, AsyncCh6CtrlSpec> {
        FnselW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Auxiliary LUT Input Select"]
    #[inline(always)]
    pub fn auxsel(&mut self) -> AuxselW<'_, AsyncCh6CtrlSpec> {
        AuxselW::new(self, 24)
    }
}
...
pub struct AsyncCh6CtrlSpec;
impl crate::RegisterSpec for AsyncCh6CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`async_ch6_ctrl::R`](R) reader structure"]
impl crate::Readable for AsyncCh6CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`async_ch6_ctrl::W`](W) writer structure"]
impl crate::Writable for AsyncCh6CtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ASYNC_CH6_CTRL to value 0x000c_0000"]
impl crate::Resettable for AsyncCh6CtrlSpec {
