#[doc = "Register `ASYNC_CH9_CTRL` reader"]
pub type R = crate::R<AsyncCh9CtrlSpec>;
#[doc = "Register `ASYNC_CH9_CTRL` writer"]
pub type W = crate::W<AsyncCh9CtrlSpec>;
#[doc = "Signal Select\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:2 - Signal Select"]
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, AsyncCh9CtrlSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Source Select"]
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, AsyncCh9CtrlSpec> {
        SourceselW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Function Select"]
    #[inline(always)]
    pub fn fnsel(&mut self) -> FnselW<'_, AsyncCh9CtrlSpec> {
        FnselW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Auxiliary LUT Input Select"]
    #[inline(always)]
    pub fn auxsel(&mut self) -> AuxselW<'_, AsyncCh9CtrlSpec> {
        AuxselW::new(self, 24)
    }
}
...
pub struct AsyncCh9CtrlSpec;
impl crate::RegisterSpec for AsyncCh9CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`async_ch9_ctrl::R`](R) reader structure"]
impl crate::Readable for AsyncCh9CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`async_ch9_ctrl::W`](W) writer structure"]
impl crate::Writable for AsyncCh9CtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ASYNC_CH9_CTRL to value 0x000c_0000"]
impl crate::Resettable for AsyncCh9CtrlSpec {
