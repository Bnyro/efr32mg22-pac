...
pub type R = crate::R<ConsumerTimer3Cc0Spec>;
#[doc = "Register `CONSUMER_TIMER3_CC0` writer"]
pub type W = crate::W<ConsumerTimer3Cc0Spec>;
...
impl W {
    #[doc = "Bits 0:3 - CC0 async channel select"]
    #[inline(always)]
    pub fn prssel(&mut self) -> PrsselW<'_, ConsumerTimer3Cc0Spec> {
        PrsselW::new(self, 0)
    }
    #[doc = "Bits 8:9 - CC0 sync channel select"]
    #[inline(always)]
    pub fn sprssel(&mut self) -> SprsselW<'_, ConsumerTimer3Cc0Spec> {
        SprsselW::new(self, 8)
    }
}
...
pub struct ConsumerTimer3Cc0Spec;
impl crate::RegisterSpec for ConsumerTimer3Cc0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`consumer_timer3_cc0::R`](R) reader structure"]
impl crate::Readable for ConsumerTimer3Cc0Spec {}
#[doc = "`write(|w| ..)` method takes [`consumer_timer3_cc0::W`](W) writer structure"]
impl crate::Writable for ConsumerTimer3Cc0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CONSUMER_TIMER3_CC0 to value 0"]
impl crate::Resettable for ConsumerTimer3Cc0Spec {}
