#[doc = "Register `CONSUMER_TIMER3_CC2` reader"]
pub type R = crate::R<ConsumerTimer3Cc2Spec>;
#[doc = "Register `CONSUMER_TIMER3_CC2` writer"]
pub type W = crate::W<ConsumerTimer3Cc2Spec>;
...
impl W {
    #[doc = "Bits 0:3 - CC2 async channel select"]
    #[inline(always)]
    pub fn prssel(&mut self) -> PrsselW<'_, ConsumerTimer3Cc2Spec> {
        PrsselW::new(self, 0)
    }
    #[doc = "Bits 8:9 - CC2 sync channel select"]
    #[inline(always)]
    pub fn sprssel(&mut self) -> SprsselW<'_, ConsumerTimer3Cc2Spec> {
        SprsselW::new(self, 8)
    }
}
...
pub struct ConsumerTimer3Cc2Spec;
impl crate::RegisterSpec for ConsumerTimer3Cc2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`consumer_timer3_cc2::R`](R) reader structure"]
impl crate::Readable for ConsumerTimer3Cc2Spec {}
