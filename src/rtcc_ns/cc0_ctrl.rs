...
pub type R = crate::R<Cc0CtrlSpec>;
#[doc = "Register `CC0_CTRL` writer"]
pub type W = crate::W<Cc0CtrlSpec>;
#[doc = "CC Channel Mode\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:1 - CC Channel Mode"]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, Cc0CtrlSpec> {
        ModeW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Compare Match Output Action"]
    #[inline(always)]
    pub fn cmoa(&mut self) -> CmoaW<'_, Cc0CtrlSpec> {
        CmoaW::new(self, 2)
    }
    #[doc = "Bit 4 - Capture compare channel comparison base."]
    #[inline(always)]
    pub fn compbase(&mut self) -> CompbaseW<'_, Cc0CtrlSpec> {
        CompbaseW::new(self, 4)
    }
    #[doc = "Bits 5:6 - Input Capture Edge Select"]
    #[inline(always)]
    pub fn icedge(&mut self) -> IcedgeW<'_, Cc0CtrlSpec> {
        IcedgeW::new(self, 5)
    }
}
...
pub struct Cc0CtrlSpec;
impl crate::RegisterSpec for Cc0CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cc0_ctrl::R`](R) reader structure"]
impl crate::Readable for Cc0CtrlSpec {}
