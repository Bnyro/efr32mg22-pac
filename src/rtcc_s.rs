...
pub struct RegisterBlock {
    ...
    cc2_ctrl: Cc2Ctrl,
    cc2_ocvalue: Cc2Ocvalue,
    cc2_icvalue: Cc2Icvalue,
}
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn cc2_ocvalue(&self) -> &Cc2Ocvalue {
        &self.cc2_ocvalue
    }
    #[doc = "0x50 - No Description"]
    #[inline(always)]
    pub const fn cc2_icvalue(&self) -> &Cc2Icvalue {
        &self.cc2_icvalue
    }
}
...
#[doc = "No Description"]
pub mod cc2_ctrl;
#[doc = "CC2_OCVALUE (rw) register accessor: No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`cc2_ocvalue::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cc2_ocvalue::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cc2_ocvalue`] module"]
#[doc(alias = "CC2_OCVALUE")]
pub type Cc2Ocvalue = crate::Reg<cc2_ocvalue::Cc2OcvalueSpec>;
#[doc = "No Description"]
pub mod cc2_ocvalue;
#[doc = "CC2_ICVALUE (r) register accessor: No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`cc2_icvalue::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cc2_icvalue`] module"]
#[doc(alias = "CC2_ICVALUE")]
pub type Cc2Icvalue = crate::Reg<cc2_icvalue::Cc2IcvalueSpec>;
#[doc = "No Description"]
pub mod cc2_icvalue;
