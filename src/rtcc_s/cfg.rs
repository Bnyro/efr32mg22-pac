...
pub type Precntccv0topR = crate::BitReader;
#[doc = "Field `PRECNTCCV0TOP` writer - Pre-counter CCV0 top value enable."]
pub type Precntccv0topW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CNTCCV1TOP` reader - CCV1 top value enable"]
pub type Cntccv1topR = crate::BitReader;
#[doc = "Field `CNTCCV1TOP` writer - CCV1 top value enable"]
pub type Cntccv1topW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl From<Cnttick> for bool {
    #[inline(always)]
    fn from(variant: Cnttick) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `CNTTICK` reader - Counter prescaler mode."]
pub type CnttickR = crate::BitReader<Cnttick>;
impl CnttickR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Cnttick {
        match self.bits {
            false => Cnttick::Presc,
            true => Cnttick::Ccv0match,
        }
    }
    ...
    pub fn is_ccv0match(&self) -> bool {
        *self == Cnttick::Ccv0match
    }
}
#[doc = "Field `CNTTICK` writer - Counter prescaler mode."]
pub type CnttickW<'a, REG> = crate::BitWriter<'a, REG, Cnttick>;
impl<'a, REG> CnttickW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "CNT register ticks according to configuration in CNTPRESC."]
    ...
    pub fn presc(self) -> &'a mut crate::W<REG> {
        self.variant(Cnttick::Presc)
    }
    #[doc = "CNT register ticks when PRECNT matches RTCC_CC0_OC\\[14:0\\]"]
    #[inline(always)]
    pub fn ccv0match(self) -> &'a mut crate::W<REG> {
        self.variant(Cnttick::Ccv0match)
    }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn precntccv0top(&self) -> Precntccv0topR {
        Precntccv0topR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - CCV1 top value enable"]
    #[inline(always)]
    pub fn cntccv1top(&self) -> Cntccv1topR {
        Cntccv1topR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Counter prescaler mode."]
    #[inline(always)]
    pub fn cnttick(&self) -> CnttickR {
        CnttickR::new(((self.bits >> 3) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 1 - Pre-counter CCV0 top value enable."]
    #[inline(always)]
    pub fn precntccv0top(&mut self) -> Precntccv0topW<'_, CfgSpec> {
        Precntccv0topW::new(self, 1)
    }
    #[doc = "Bit 2 - CCV1 top value enable"]
    #[inline(always)]
    pub fn cntccv1top(&mut self) -> Cntccv1topW<'_, CfgSpec> {
        Cntccv1topW::new(self, 2)
    }
    #[doc = "Bit 3 - Counter prescaler mode."]
    #[inline(always)]
    pub fn cnttick(&mut self) -> CnttickW<'_, CfgSpec> {
        CnttickW::new(self, 3)
    }
    #[doc = "Bits 4:7 - Counter prescaler value."]
    #[inline(always)]
