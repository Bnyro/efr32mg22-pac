...
#[doc = "Field `ESAUMRB01` reader - Moveable Region Boundary 0-1"]
pub type Esaumrb01R = crate::FieldReader<u16>;
#[doc = "Field `ESAUMRB01` writer - Moveable Region Boundary 0-1"]
pub type Esaumrb01W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 12:27 - Moveable Region Boundary 0-1"]
    #[inline(always)]
...
#[doc = "`reset()` method sets ESAUMRB01 to value 0x0200_0000"]
