...
#[doc = "Field `ESAUMRB12` reader - Moveable Region Boundary 1-2"]
pub type Esaumrb12R = crate::FieldReader<u16>;
#[doc = "Field `ESAUMRB12` writer - Moveable Region Boundary 1-2"]
pub type Esaumrb12W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 12:27 - Moveable Region Boundary 1-2"]
    #[inline(always)]
...
#[doc = "`reset()` method sets ESAUMRB12 to value 0x0400_0000"]
