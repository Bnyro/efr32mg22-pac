...
#[doc = "Field `ESAUMRB45` reader - Moveable Region Boundary 4-5"]
pub type Esaumrb45R = crate::FieldReader<u16>;
#[doc = "Field `ESAUMRB45` writer - Moveable Region Boundary 4-5"]
pub type Esaumrb45W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 12:27 - Moveable Region Boundary 4-5"]
    #[inline(always)]
