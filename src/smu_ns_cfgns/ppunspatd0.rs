...
#[doc = "Field `IFADCDEBUG` reader - IFADCDEBUG Privileged Access"]
pub type IfadcdebugR = crate::BitReader;
#[doc = "Field `IFADCDEBUG` writer - IFADCDEBUG Privileged Access"]
...
impl R {
    ...
    #[doc = "Bit 29 - IFADCDEBUG Privileged Access"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 1 - EMU Privileged Access"]
    #[inline(always)]
    pub fn emu(&mut self) -> EmuW<'_, Ppunspatd0Spec> {
        EmuW::new(self, 1)
    }
    #[doc = "Bit 2 - CMU Privileged Access"]
    #[inline(always)]
    pub fn cmu(&mut self) -> CmuW<'_, Ppunspatd0Spec> {
        CmuW::new(self, 2)
    }
    #[doc = "Bit 3 - HFXO0 Privileged Access"]
    #[inline(always)]
    pub fn hfxo0(&mut self) -> Hfxo0W<'_, Ppunspatd0Spec> {
        Hfxo0W::new(self, 3)
    }
    #[doc = "Bit 4 - HFRCO0 Privileged Access"]
    #[inline(always)]
    pub fn hfrco0(&mut self) -> Hfrco0W<'_, Ppunspatd0Spec> {
        Hfrco0W::new(self, 4)
    }
    #[doc = "Bit 5 - FSRCO Privileged Access"]
    #[inline(always)]
    pub fn fsrco(&mut self) -> FsrcoW<'_, Ppunspatd0Spec> {
        FsrcoW::new(self, 5)
    }
    #[doc = "Bit 6 - DPLL0 Privileged Access"]
    #[inline(always)]
    pub fn dpll0(&mut self) -> Dpll0W<'_, Ppunspatd0Spec> {
        Dpll0W::new(self, 6)
    }
    #[doc = "Bit 7 - LFXO Privileged Access"]
    #[inline(always)]
    pub fn lfxo(&mut self) -> LfxoW<'_, Ppunspatd0Spec> {
        LfxoW::new(self, 7)
    }
    #[doc = "Bit 8 - LFRCO Privileged Access"]
    #[inline(always)]
    pub fn lfrco(&mut self) -> LfrcoW<'_, Ppunspatd0Spec> {
        LfrcoW::new(self, 8)
    }
    #[doc = "Bit 9 - ULFRCO Privileged Access"]
    #[inline(always)]
    pub fn ulfrco(&mut self) -> UlfrcoW<'_, Ppunspatd0Spec> {
        UlfrcoW::new(self, 9)
    }
    #[doc = "Bit 10 - MSC Privileged Access"]
    #[inline(always)]
    pub fn msc(&mut self) -> MscW<'_, Ppunspatd0Spec> {
        MscW::new(self, 10)
    }
    #[doc = "Bit 11 - ICACHE0 Privileged Access"]
    #[inline(always)]
    pub fn icache0(&mut self) -> Icache0W<'_, Ppunspatd0Spec> {
        Icache0W::new(self, 11)
    }
    #[doc = "Bit 12 - PRS Privileged Access"]
    #[inline(always)]
    pub fn prs(&mut self) -> PrsW<'_, Ppunspatd0Spec> {
        PrsW::new(self, 12)
    }
    #[doc = "Bit 13 - GPIO Privileged Access"]
    #[inline(always)]
    pub fn gpio(&mut self) -> GpioW<'_, Ppunspatd0Spec> {
        GpioW::new(self, 13)
    }
    #[doc = "Bit 14 - LDMA Privileged Access"]
    #[inline(always)]
    pub fn ldma(&mut self) -> LdmaW<'_, Ppunspatd0Spec> {
        LdmaW::new(self, 14)
    }
    #[doc = "Bit 15 - LDMAXBAR Privileged Access"]
    #[inline(always)]
    pub fn ldmaxbar(&mut self) -> LdmaxbarW<'_, Ppunspatd0Spec> {
        LdmaxbarW::new(self, 15)
    }
    #[doc = "Bit 16 - TIMER0 Privileged Access"]
    #[inline(always)]
    pub fn timer0(&mut self) -> Timer0W<'_, Ppunspatd0Spec> {
        Timer0W::new(self, 16)
    }
    #[doc = "Bit 17 - TIMER1 Privileged Access"]
    #[inline(always)]
    pub fn timer1(&mut self) -> Timer1W<'_, Ppunspatd0Spec> {
        Timer1W::new(self, 17)
    }
    #[doc = "Bit 18 - TIMER2 Privileged Access"]
    #[inline(always)]
    pub fn timer2(&mut self) -> Timer2W<'_, Ppunspatd0Spec> {
        Timer2W::new(self, 18)
    }
    #[doc = "Bit 19 - TIMER3 Privileged Access"]
    #[inline(always)]
    pub fn timer3(&mut self) -> Timer3W<'_, Ppunspatd0Spec> {
        Timer3W::new(self, 19)
    }
    #[doc = "Bit 20 - TIMER4 Privileged Access"]
    #[inline(always)]
    pub fn timer4(&mut self) -> Timer4W<'_, Ppunspatd0Spec> {
        Timer4W::new(self, 20)
    }
    #[doc = "Bit 21 - USART0 Privileged Access"]
    #[inline(always)]
    pub fn usart0(&mut self) -> Usart0W<'_, Ppunspatd0Spec> {
        Usart0W::new(self, 21)
    }
    #[doc = "Bit 22 - USART1 Privileged Access"]
    #[inline(always)]
    pub fn usart1(&mut self) -> Usart1W<'_, Ppunspatd0Spec> {
        Usart1W::new(self, 22)
    }
    #[doc = "Bit 23 - BURTC Privileged Access"]
    #[inline(always)]
    pub fn burtc(&mut self) -> BurtcW<'_, Ppunspatd0Spec> {
        BurtcW::new(self, 23)
    }
    #[doc = "Bit 24 - I2C1 Privileged Access"]
    #[inline(always)]
    pub fn i2c1(&mut self) -> I2c1W<'_, Ppunspatd0Spec> {
        I2c1W::new(self, 24)
    }
    #[doc = "Bit 25 - CHIPTESTCTRL Privileged Access"]
    #[inline(always)]
    pub fn chiptestctrl(&mut self) -> ChiptestctrlW<'_, Ppunspatd0Spec> {
        ChiptestctrlW::new(self, 25)
    }
    #[doc = "Bit 26 - SYSCFGCFGNS Privileged Access"]
    #[inline(always)]
    pub fn syscfgcfgns(&mut self) -> SyscfgcfgnsW<'_, Ppunspatd0Spec> {
        SyscfgcfgnsW::new(self, 26)
    }
    #[doc = "Bit 27 - SYSCFG Privileged Access"]
    #[inline(always)]
    pub fn syscfg(&mut self) -> SyscfgW<'_, Ppunspatd0Spec> {
        SyscfgW::new(self, 27)
    }
    #[doc = "Bit 28 - BURAM Privileged Access"]
    #[inline(always)]
    pub fn buram(&mut self) -> BuramW<'_, Ppunspatd0Spec> {
        BuramW::new(self, 28)
    }
    #[doc = "Bit 29 - IFADCDEBUG Privileged Access"]
    #[inline(always)]
    pub fn ifadcdebug(&mut self) -> IfadcdebugW<'_, Ppunspatd0Spec> {
        IfadcdebugW::new(self, 29)
    }
    #[doc = "Bit 30 - GPCRC Privileged Access"]
    #[inline(always)]
    pub fn gpcrc(&mut self) -> GpcrcW<'_, Ppunspatd0Spec> {
        GpcrcW::new(self, 30)
    }
    #[doc = "Bit 31 - DCI Privileged Access"]
    #[inline(always)]
    pub fn dci(&mut self) -> DciW<'_, Ppunspatd0Spec> {
        DciW::new(self, 31)
    }
}
