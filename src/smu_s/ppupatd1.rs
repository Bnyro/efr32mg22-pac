...
impl W {
    #[doc = "Bit 1 - DCDC Privileged Access"]
    #[inline(always)]
    pub fn dcdc(&mut self) -> DcdcW<'_, Ppupatd1Spec> {
        DcdcW::new(self, 1)
    }
    #[doc = "Bit 2 - PDM Privileged Access"]
    #[inline(always)]
    pub fn pdm(&mut self) -> PdmW<'_, Ppupatd1Spec> {
        PdmW::new(self, 2)
    }
    #[doc = "Bit 3 - RFSENSE Privileged Access"]
    #[inline(always)]
    pub fn rfsense(&mut self) -> RfsenseW<'_, Ppupatd1Spec> {
        RfsenseW::new(self, 3)
    }
    #[doc = "Bit 4 - RADIOAES Privileged Access"]
    #[inline(always)]
    ...
    #[doc = "Bit 13 - EUART0 Privileged Access"]
    #[inline(always)]
    pub fn euart0(&mut self) -> Euart0W<'_, Ppupatd1Spec> {
        Euart0W::new(self, 13)
    }
    #[doc = "Bit 14 - CRYPTOACC Privileged Access"]
    #[inline(always)]
    pub fn cryptoacc(&mut self) -> CryptoaccW<'_, Ppupatd1Spec> {
