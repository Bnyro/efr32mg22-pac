...
#[doc = "Field `USART1` reader - USART1 Secure Access"]
pub type Usart1R = crate::BitReader;
#[doc = "Field `USART1` writer - USART1 Secure Access"]
...
#[doc = "Field `IFADCDEBUG` reader - IFADCDEBUG Secure Access"]
pub type IfadcdebugR = crate::BitReader;
#[doc = "Field `IFADCDEBUG` writer - IFADCDEBUG Secure Access"]
...
#[doc = "Field `DCI` reader - DCI Secure Access"]
pub type DciR = crate::BitReader;
#[doc = "Field `DCI` writer - DCI Secure Access"]
pub type DciW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 3 - HFXO0 Secure Access"]
    #[inline(always)]
    pub fn hfxo0(&self) -> Hfxo0R {
        Hfxo0R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - HFRCO0 Secure Access"]
    #[inline(always)]
    pub fn hfrco0(&self) -> Hfrco0R {
        Hfrco0R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - FSRCO Secure Access"]
    #[inline(always)]
    pub fn fsrco(&self) -> FsrcoR {
        FsrcoR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - DPLL0 Secure Access"]
    #[inline(always)]
    pub fn dpll0(&self) -> Dpll0R {
        Dpll0R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - LFXO Secure Access"]
    #[inline(always)]
    pub fn lfxo(&self) -> LfxoR {
        LfxoR::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - LFRCO Secure Access"]
    #[inline(always)]
    pub fn lfrco(&self) -> LfrcoR {
        LfrcoR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - ULFRCO Secure Access"]
    #[inline(always)]
    pub fn ulfrco(&self) -> UlfrcoR {
        UlfrcoR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - MSC Secure Access"]
    #[inline(always)]
    pub fn msc(&self) -> MscR {
        MscR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - ICACHE0 Secure Access"]
    #[inline(always)]
    pub fn icache0(&self) -> Icache0R {
        Icache0R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - PRS Secure Access"]
    #[inline(always)]
    pub fn prs(&self) -> PrsR {
        PrsR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - GPIO Secure Access"]
    #[inline(always)]
    pub fn gpio(&self) -> GpioR {
        GpioR::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - LDMA Secure Access"]
    #[inline(always)]
    pub fn ldma(&self) -> LdmaR {
        LdmaR::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - LDMAXBAR Secure Access"]
    #[inline(always)]
    pub fn ldmaxbar(&self) -> LdmaxbarR {
        LdmaxbarR::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - TIMER0 Secure Access"]
    #[inline(always)]
    pub fn timer0(&self) -> Timer0R {
        Timer0R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - TIMER1 Secure Access"]
    #[inline(always)]
    pub fn timer1(&self) -> Timer1R {
        Timer1R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - TIMER2 Secure Access"]
    #[inline(always)]
    pub fn timer2(&self) -> Timer2R {
        Timer2R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - TIMER3 Secure Access"]
    #[inline(always)]
    pub fn timer3(&self) -> Timer3R {
        Timer3R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20 - TIMER4 Secure Access"]
    #[inline(always)]
    pub fn timer4(&self) -> Timer4R {
        Timer4R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - USART0 Secure Access"]
    #[inline(always)]
    pub fn usart0(&self) -> Usart0R {
        Usart0R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - USART1 Secure Access"]
    #[inline(always)]
    pub fn usart1(&self) -> Usart1R {
        Usart1R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - BURTC Secure Access"]
    #[inline(always)]
    pub fn burtc(&self) -> BurtcR {
        BurtcR::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - I2C1 Secure Access"]
    #[inline(always)]
    pub fn i2c1(&self) -> I2c1R {
        I2c1R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - CHIPTESTCTRL Secure Access"]
    #[inline(always)]
    pub fn chiptestctrl(&self) -> ChiptestctrlR {
        ChiptestctrlR::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - SYSCFGCFGNS Secure Access"]
    #[inline(always)]
    pub fn syscfgcfgns(&self) -> SyscfgcfgnsR {
        SyscfgcfgnsR::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - SYSCFG Secure Access"]
    #[inline(always)]
    pub fn syscfg(&self) -> SyscfgR {
        SyscfgR::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - BURAM Secure Access"]
    #[inline(always)]
    pub fn buram(&self) -> BuramR {
        BuramR::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - IFADCDEBUG Secure Access"]
    #[inline(always)]
    pub fn ifadcdebug(&self) -> IfadcdebugR {
        IfadcdebugR::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - GPCRC Secure Access"]
    #[inline(always)]
    pub fn gpcrc(&self) -> GpcrcR {
        GpcrcR::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - DCI Secure Access"]
    #[inline(always)]
    pub fn dci(&self) -> DciR {
        DciR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 1 - EMU Secure Access"]
    #[inline(always)]
    pub fn emu(&mut self) -> EmuW<'_, Ppusatd0Spec> {
        EmuW::new(self, 1)
    }
    #[doc = "Bit 2 - CMU Secure Access"]
    #[inline(always)]
    pub fn cmu(&mut self) -> CmuW<'_, Ppusatd0Spec> {
        CmuW::new(self, 2)
    }
    #[doc = "Bit 3 - HFXO0 Secure Access"]
    #[inline(always)]
    pub fn hfxo0(&mut self) -> Hfxo0W<'_, Ppusatd0Spec> {
        Hfxo0W::new(self, 3)
    }
    #[doc = "Bit 4 - HFRCO0 Secure Access"]
    #[inline(always)]
    pub fn hfrco0(&mut self) -> Hfrco0W<'_, Ppusatd0Spec> {
        Hfrco0W::new(self, 4)
    }
    #[doc = "Bit 5 - FSRCO Secure Access"]
    #[inline(always)]
    pub fn fsrco(&mut self) -> FsrcoW<'_, Ppusatd0Spec> {
        FsrcoW::new(self, 5)
    }
    #[doc = "Bit 6 - DPLL0 Secure Access"]
    #[inline(always)]
    pub fn dpll0(&mut self) -> Dpll0W<'_, Ppusatd0Spec> {
        Dpll0W::new(self, 6)
    }
    #[doc = "Bit 7 - LFXO Secure Access"]
    #[inline(always)]
    pub fn lfxo(&mut self) -> LfxoW<'_, Ppusatd0Spec> {
        LfxoW::new(self, 7)
    }
    #[doc = "Bit 8 - LFRCO Secure Access"]
    #[inline(always)]
    pub fn lfrco(&mut self) -> LfrcoW<'_, Ppusatd0Spec> {
        LfrcoW::new(self, 8)
    }
    #[doc = "Bit 9 - ULFRCO Secure Access"]
    #[inline(always)]
    pub fn ulfrco(&mut self) -> UlfrcoW<'_, Ppusatd0Spec> {
        UlfrcoW::new(self, 9)
    }
    #[doc = "Bit 10 - MSC Secure Access"]
    #[inline(always)]
    pub fn msc(&mut self) -> MscW<'_, Ppusatd0Spec> {
        MscW::new(self, 10)
    }
    #[doc = "Bit 11 - ICACHE0 Secure Access"]
    #[inline(always)]
    pub fn icache0(&mut self) -> Icache0W<'_, Ppusatd0Spec> {
        Icache0W::new(self, 11)
    }
    #[doc = "Bit 12 - PRS Secure Access"]
    #[inline(always)]
    pub fn prs(&mut self) -> PrsW<'_, Ppusatd0Spec> {
        PrsW::new(self, 12)
    }
    #[doc = "Bit 13 - GPIO Secure Access"]
    #[inline(always)]
    pub fn gpio(&mut self) -> GpioW<'_, Ppusatd0Spec> {
        GpioW::new(self, 13)
    }
    #[doc = "Bit 14 - LDMA Secure Access"]
    #[inline(always)]
    pub fn ldma(&mut self) -> LdmaW<'_, Ppusatd0Spec> {
        LdmaW::new(self, 14)
    }
    #[doc = "Bit 15 - LDMAXBAR Secure Access"]
    #[inline(always)]
    pub fn ldmaxbar(&mut self) -> LdmaxbarW<'_, Ppusatd0Spec> {
        LdmaxbarW::new(self, 15)
    }
    #[doc = "Bit 16 - TIMER0 Secure Access"]
    #[inline(always)]
    pub fn timer0(&mut self) -> Timer0W<'_, Ppusatd0Spec> {
        Timer0W::new(self, 16)
    }
    #[doc = "Bit 17 - TIMER1 Secure Access"]
    #[inline(always)]
    pub fn timer1(&mut self) -> Timer1W<'_, Ppusatd0Spec> {
        Timer1W::new(self, 17)
    }
    #[doc = "Bit 18 - TIMER2 Secure Access"]
    #[inline(always)]
    pub fn timer2(&mut self) -> Timer2W<'_, Ppusatd0Spec> {
        Timer2W::new(self, 18)
    }
    #[doc = "Bit 19 - TIMER3 Secure Access"]
    #[inline(always)]
    pub fn timer3(&mut self) -> Timer3W<'_, Ppusatd0Spec> {
        Timer3W::new(self, 19)
    }
    #[doc = "Bit 20 - TIMER4 Secure Access"]
    #[inline(always)]
    pub fn timer4(&mut self) -> Timer4W<'_, Ppusatd0Spec> {
        Timer4W::new(self, 20)
    }
    #[doc = "Bit 21 - USART0 Secure Access"]
    #[inline(always)]
    pub fn usart0(&mut self) -> Usart0W<'_, Ppusatd0Spec> {
        Usart0W::new(self, 21)
    }
    #[doc = "Bit 22 - USART1 Secure Access"]
    #[inline(always)]
    pub fn usart1(&mut self) -> Usart1W<'_, Ppusatd0Spec> {
        Usart1W::new(self, 22)
    }
    #[doc = "Bit 23 - BURTC Secure Access"]
    #[inline(always)]
    pub fn burtc(&mut self) -> BurtcW<'_, Ppusatd0Spec> {
        BurtcW::new(self, 23)
    }
    #[doc = "Bit 24 - I2C1 Secure Access"]
    #[inline(always)]
    pub fn i2c1(&mut self) -> I2c1W<'_, Ppusatd0Spec> {
        I2c1W::new(self, 24)
    }
    #[doc = "Bit 25 - CHIPTESTCTRL Secure Access"]
    #[inline(always)]
    pub fn chiptestctrl(&mut self) -> ChiptestctrlW<'_, Ppusatd0Spec> {
        ChiptestctrlW::new(self, 25)
    }
    #[doc = "Bit 26 - SYSCFGCFGNS Secure Access"]
    #[inline(always)]
    pub fn syscfgcfgns(&mut self) -> SyscfgcfgnsW<'_, Ppusatd0Spec> {
        SyscfgcfgnsW::new(self, 26)
    }
    #[doc = "Bit 27 - SYSCFG Secure Access"]
    #[inline(always)]
    pub fn syscfg(&mut self) -> SyscfgW<'_, Ppusatd0Spec> {
        SyscfgW::new(self, 27)
    }
    #[doc = "Bit 28 - BURAM Secure Access"]
    #[inline(always)]
    pub fn buram(&mut self) -> BuramW<'_, Ppusatd0Spec> {
        BuramW::new(self, 28)
    }
    #[doc = "Bit 29 - IFADCDEBUG Secure Access"]
    #[inline(always)]
    pub fn ifadcdebug(&mut self) -> IfadcdebugW<'_, Ppusatd0Spec> {
        IfadcdebugW::new(self, 29)
    }
    #[doc = "Bit 30 - GPCRC Secure Access"]
    #[inline(always)]
    pub fn gpcrc(&mut self) -> GpcrcW<'_, Ppusatd0Spec> {
        GpcrcW::new(self, 30)
    }
    #[doc = "Bit 31 - DCI Secure Access"]
    #[inline(always)]
    pub fn dci(&mut self) -> DciW<'_, Ppusatd0Spec> {
        DciW::new(self, 31)
    }
}
