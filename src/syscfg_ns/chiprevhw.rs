...
#[doc = "Field `MAJOR` reader - Hardwired Chip Major value"]
pub type MajorR = crate::FieldReader;
#[doc = "Field `MAJOR` writer - Hardwired Chip Major value"]
...
#[doc = "Field `MINOR` reader - Hardwired Chip Minor value"]
pub type MinorR = crate::FieldReader;
#[doc = "Field `MINOR` writer - Hardwired Chip Minor value"]
pub type MinorW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:5 - Hardwired Chip Major value"]
    #[inline(always)]
    ...
    #[doc = "Bits 12:19 - Hardwired Chip Minor value"]
    #[inline(always)]
...
#[doc = "`reset()` method sets CHIPREVHW to value 0x0d02"]
