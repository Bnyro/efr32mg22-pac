...
#[repr(u8)]
pub enum Family {
    #[doc = "24: Product is in PG22 family"]
    Pg22 = 24,
    #[doc = "52: Product is in MG22 family"]
    Mg22 = 52,
    #[doc = "53: Product is in BG22 family"]
    Bg22 = 53,
    #[doc = "55: Product is in FG22 family"]
    Fg22 = 55,
}
...
impl FamilyR {
    ...
    #[inline(always)]
    pub fn is_pg22(&self) -> bool {
        *self == Family::Pg22
    }
    #[doc = "Product is in MG22 family"]
    #[inline(always)]
    pub fn is_mg22(&self) -> bool {
        *self == Family::Mg22
    }
    #[doc = "Product is in BG22 family"]
    #[inline(always)]
    pub fn is_bg22(&self) -> bool {
        *self == Family::Bg22
    }
    #[doc = "Product is in FG22 family"]
    #[inline(always)]
    pub fn is_fg22(&self) -> bool {
        *self == Family::Fg22
    }
}
    ...
    REG::Ux: From<u8>,
{
    #[doc = "Product is in PG22 family"]
    #[inline(always)]
    pub fn pg22(self) -> &'a mut crate::W<REG> {
        self.variant(Family::Pg22)
    }
    #[doc = "Product is in MG22 family"]
    #[inline(always)]
    pub fn mg22(self) -> &'a mut crate::W<REG> {
        self.variant(Family::Mg22)
    }
    #[doc = "Product is in BG22 family"]
    #[inline(always)]
    pub fn bg22(self) -> &'a mut crate::W<REG> {
        self.variant(Family::Bg22)
    }
    #[doc = "Product is in FG22 family"]
    #[inline(always)]
    pub fn fg22(self) -> &'a mut crate::W<REG> {
        self.variant(Family::Fg22)
    }
}
