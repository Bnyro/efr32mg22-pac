...
#[doc = "Field `ROOTMODELOCK` reader - Root Mode Lock"]
pub type RootmodelockR = crate::BitReader;
...
#[doc = "Field `RADIODBGLOCK` reader - Radio Debug Lock"]
pub type RadiodbglockR = crate::BitReader;
impl R {
    #[doc = "Bit 0 - Bus Lock"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Root Mode Lock"]
    #[inline(always)]
    pub fn rootmodelock(&self) -> RootmodelockR {
        RootmodelockR::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    #[doc = "Bit 16 - User Invasive Debug Lock"]
    #[inline(always)]
    pub fn userdbglock(&self) -> UserdbglockR {
        UserdbglockR::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - User Non-invasive Debug Lock"]
    #[inline(always)]
    pub fn usernidlock(&self) -> UsernidlockR {
        UsernidlockR::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - User Secure Invasive Debug Lock"]
    #[inline(always)]
    pub fn userspidlock(&self) -> UserspidlockR {
        UserspidlockR::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - User Secure Non-invasive Debug Lock"]
    #[inline(always)]
    pub fn userspnidlock(&self) -> UserspnidlockR {
        UserspnidlockR::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20 - User Debug Access Port Lock"]
    #[inline(always)]
    pub fn userdbgaplock(&self) -> UserdbgaplockR {
        UserdbgaplockR::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 24 - Radio Debug Lock"]
    #[inline(always)]
    pub fn radiodbglock(&self) -> RadiodbglockR {
        RadiodbglockR::new(((self.bits >> 24) & 1) != 0)
    }
}
...
impl crate::Resettable for RootlockstatusSpec {
    const RESET_VALUE: u32 = 0x011f_0107;
}
